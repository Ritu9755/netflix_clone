...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
        ...
        <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-61 mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Unlimited movies, TV shows, and more</h1>
            <p className="text-lg mb-4">Watch anythings. Cancel anything.</p>
            ...
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
                ...
                <div className="flex-1"> 
                    ...
                    <img src="/stranger-things-lg.png" alt="Stranger Things image" className="mt-4"></img>
                        ...
                        w-3/4 lg:1/2 h-24 border-slate-500 rounded-md px-2"
                        >
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-lg md:text-xl">
                        Save your favourites easily and always have somwthings to watch.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse  px-4 md:px-2">
                {/* Left Side */}
                <div className="flex-1 relative"> 
                    <img src="/kids.png" alt="Enjoy on your TV" className="mt-4"></img>
                </div>
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-lg md:text-xl">
                        Send kids on adventures with their favorite character in a space made just for them-free
